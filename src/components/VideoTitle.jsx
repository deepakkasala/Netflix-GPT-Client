...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="absolute top-0 left-0 w-full h-full text-white flex flex-col justify-center px-4 sm:px-6 md:px-12 z-10 bg-gradient-to-r from-black/80 to-transparent">
      <h1 className="text-xl sm:text-lg md:text-2xl lg:text-3xl font-bold leading-snug">
        {title}
      </h1>
      <p className="py-4 sm:py-6 text-sm sm:text-base md:text-md lg:text-lg max-w-xl md:max-w-2xl text-gray-200">
        {overview}
      </p>
